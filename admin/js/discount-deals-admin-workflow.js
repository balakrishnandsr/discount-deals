...
(function ($, data) {
	...
	function init_discounts() {
		...
		$( document ).on(
			'click',
			'.discount-deals-add-cart-discount',
			function () {
	...
	function init_promotions() {
		...
		$( document ).on(
			'change',
			'input[type=radio][name="discount_deals_workflow[dd_promotion][enable]"]',
			function () {
