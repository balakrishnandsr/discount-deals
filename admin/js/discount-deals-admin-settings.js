...
(function ($, data) {
	...
	$(document).on(
		'change',
		'#wc_settings_tab_discount_deals_apply_product_discount_to',
		function () {
	...
	$(document).on(
		'change',
		'#wc_settings_tab_discount_deals_apply_cart_discount_to',
		function () {
	...
	$(document).on(
		'change',
		'input[name="wc_settings_tab_discount_deals_apply_cart_discount_as"]',
		function () {
	...
	$(document).on(
		'change',
		'#wc_settings_tab_discount_deals_where_display_saving_text',
		function () {
	...
	$(document).on(
		'change',
		'input[name=wc_settings_tab_discount_deals_show_applied_discounts_message]',
		function () {
