...
<script type="text/template" id="tmpl-discount-deals-rule">
    ...
    <div class="discount-deals-rule discount-deals-grid discount-deals-rule--type-{{ data.rule.object.type ? data.rule.object.type : 'new' }} discount-deals-rule--compare-{{ data.rule.compare }}">
        <div class="discount-deals-rule__fields discount-deals-col-11 discount-deals-grid">
                    ...
                    <# } else if ( data.rule.object.type === 'select' ) { #>
                        <# if ( data.rule.object.is_single_select ) { #>
                            <select name="{{ data.field_name_base }}[value]" class="discount-deals-field wc-enhanced-select discount-deals-rule-value-field" data-placeholder="{{{ data.rule.object.placeholder }}}">
                                ...
                                <# } #>
                        <# } else { #>
                            <select name="{{ data.field_name_base }}[value][]" multiple="multiple" class="discount-deals-field wc-enhanced-select discount-deals-rule-value-field">
                        <# } #>
                    ...
                    <# } else if ( data.rule.object.type === 'date' ) { #>
                        ...
                        <# if ( data.rule.object.has_days_of_the_week === true ) { #>
                            <div class="discount-deals-hidden" data-discount-deals-compare="days_of_the_week">
                                <select name="{{ data.field_name_base }}[value][dow][]" multiple required class="discount-deals-field discount-deals-rule-value-field discount-deals-rule-value-dow wc-enhanced-select">
        ...
        <div class="discount-deals-rule__buttons discount-deals-col-1">
